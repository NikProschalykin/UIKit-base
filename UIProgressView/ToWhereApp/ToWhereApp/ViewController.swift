...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        button.contentEdgeInsets = UIEdgeInsets(top: 0, left: 2, bottom: 0, right: 2) //отступы
        button.addTarget(self, action: #selector(buttonAction(sender:)), for: .touchUpInside)
        
        progress.cancellationHandler = { // когда отмена или окончания прогресса
        ...
        NSLayoutConstraint.activate([
            ...
            topLabel.topAnchor.constraint(equalTo: view.topAnchor,constant: 160),
    ...
    func updateWithAnimation(task: @escaping () -> Void, completion: @escaping () -> Void) {
        UIView.animate(withDuration: 0.25, animations: task,completion: { _ in
